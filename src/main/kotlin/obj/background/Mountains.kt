...
class Mountains(x: Int = 0, y: Int = 0): GameObject(x, y, Global.WINDOW_WIDTH, Global.WINDOW_HEIGHT*8/10) {
    private val imgBackGround: Image = ResController.instance.image(Path.Imgs.BackGround.mountains)
